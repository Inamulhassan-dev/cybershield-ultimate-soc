...
function animateRadar() {
    ...
    radarBlips.forEach(blip => {
        ...
        const pulseR = 4 + Math.sin(time * 3 + blip.pulse) * 1.5;
        ...
        const glowColor = blip.type === 'threat' ? `rgba(255, 0, 60, ${brightness * 0.15})` : `rgba(0, 247, 255, ${brightness * 0.1})`;
        radarCtx.fillStyle = glowColor;
        radarCtx.fill();
